...
const Hero: React.FC = () => {
  ...
  const toRotate = useMemo(() => ["Java Full Stack Developer", "Spring Boot Expert", "Cloud Architect", "React Specialist", "3X Azure Certified"], []);
  ...
  return (
    <section id="about" className="relative min-h-[100dvh] flex items-center justify-center pt-20 px-6">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-semibold text-white">
                            <DecryptedText text={RESUME_DATA.email} useGlitch={true} />
                          </p>
                        </div>
                      </div>
                    </div>
